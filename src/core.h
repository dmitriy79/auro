...
public:
    ...
    // GetValueIn() is a method on CCoinsViewCache, because inputs must be known to compute value in.
...
//BlockHeader- Collect transactions into a block, hash them, scan nonce, broadcast
class CBlockHeader
{
public:
    // header
...
//Finding common trunk to determine fork depth
